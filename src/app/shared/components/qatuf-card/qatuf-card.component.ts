...
@Component({
  selector: 'app-qatuf-card',
  templateUrl: './qatuf-card.component.html',
  styleUrls: ['./qatuf-card.component.css']
})
export class QatufCardComponent implements OnChanges , OnInit, AfterViewInit {
