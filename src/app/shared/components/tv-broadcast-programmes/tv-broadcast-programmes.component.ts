...
import { HomeService, VideoDetails } from 'src/app/home/core/services/home.service';
import { IYoutubeDisplayItem } from '../../core/models/iyoutube-display-item';
import { DomSanitizer, SafeResourceUrl } from '@angular/platform-browser';

@Component({
  selector: 'app-tv-broadcast-programmes',
  templateUrl: './tv-broadcast-programmes.component.html',
  styleUrls: ['./tv-broadcast-programmes.component.css']
})
export class TvBroadcastProgrammesComponent implements OnInit  {
